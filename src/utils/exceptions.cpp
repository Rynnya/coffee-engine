    ...
    const char* VulkanException::resultToErrorMessage(VkResult result) noexcept
    {
        switch (result) {
            ...
            case VK_PIPELINE_COMPILE_REQUIRED:
                return "VK_PIPELINE_COMPILE_REQUIRED: A requested pipeline creation would have required compilation, but the application "
            ...
            case VK_SUBOPTIMAL_KHR:
                return "VK_SUBOPTIMAL_KHR: A swapchain no longer matches the surface properties exactly, but can still be used to present "
            ...
            case VK_THREAD_IDLE_KHR:
                return "VK_THREAD_IDLE_KHR: A deferred operation is not complete but there is currently no work for this thread to do at "
                       "the time of this call";
            case VK_THREAD_DONE_KHR:
                return "VK_THREAD_DONE_KHR: A deferred operation is not complete but there is no work remaining to assign to additional "
                       "threads";

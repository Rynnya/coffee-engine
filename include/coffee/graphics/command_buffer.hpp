...
namespace graphics {
    ...
    public:
        ...
        inline void bindDescriptorSets(const GraphicsPipelinePtr& pipeline, const DescriptorSetPtr& descriptor, size_t firstSet = 0U) const noexcept
        {
        ...
        inline void bindDescriptorSets(const ComputePipelinePtr& pipeline, const DescriptorSetPtr& descriptor, size_t firstSet = 0U) const noexcept
        {
        ...
        inline void drawIndirect(const BufferPtr& drawBuffer, VkDeviceSize offset = 0U, uint32_t drawCount = 1U, uint32_t stride = 0U) const noexcept
        {
            COFFEE_ASSERT(type == CommandBufferType::Graphics, "You can only draw on graphics command buffers.");
        ...
        ) const noexcept
        {
            ...
            vkCmdPipelineBarrier(buffer_, srcStageMask, dstStageMask, dependencyFlags, memoryBarrierCount, pMemoryBarriers, 0, nullptr, 0, nullptr);
        }
